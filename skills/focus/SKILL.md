...
Input (raw capture list)
  ...
  │    ├─ Obsidian: search Roster, CRM, Decisions, Transcripts
...
```
People context:
  Notion/Company/Team/Roster.md       → employee/candidate profiles
...
Alice:
  ...
  Roster status: A-level team member
...
BEFORE: "New hire Roster" (vague)
AFTER:  "Add [new hire name] to Roster"
```
