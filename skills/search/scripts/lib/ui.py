"""Terminal UI utilities for search skill."""
...
MINI_BANNER = f"""{Colors.PURPLE}{Colors.BOLD}/search --social{Colors.RESET} {Colors.DIM}· researching...{Colors.RESET}"""
...
{Colors.YELLOW}Unlock social search for /search --social{Colors.RESET}
...
{Colors.DIM}Setup:{Colors.RESET} Edit {Colors.BOLD}~/.claude/.env{Colors.RESET}
{Colors.YELLOW}{Colors.BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{Colors.RESET}
"""

PROMO_MESSAGE_PLAIN = """
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Unlock social search for /search --social
...
PROMO_SINGLE_KEY = {
    "reddit": f"""
{Colors.DIM}Tip: Add {Colors.YELLOW}OPENAI_API_KEY{Colors.RESET}{Colors.DIM} to ~/.claude/.env for Reddit data with real engagement metrics.{Colors.RESET}
""",
    "x": f"""
{Colors.DIM}Tip: Add {Colors.CYAN}XAI_API_KEY{Colors.RESET}{Colors.DIM} to ~/.claude/.env for X/Twitter data with real likes & reposts.{Colors.RESET}
""",
}

PROMO_SINGLE_KEY_PLAIN = {
    "reddit": "\nTip: Add OPENAI_API_KEY to ~/.claude/.env for Reddit data with real engagement metrics.\n",
    "x": "\nTip: Add XAI_API_KEY to ~/.claude/.env for X/Twitter data with real likes & reposts.\n",
}
...
class ProgressDisplay:
    ...
    def _show_banner(self):
        if IS_TTY:
            ...
            sys.stderr.write(f"Social search: {self.topic}\n")
        sys.stderr.flush()
